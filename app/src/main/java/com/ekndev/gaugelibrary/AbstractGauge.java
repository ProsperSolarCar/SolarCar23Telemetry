...
abstract class AbstractGauge extends View {
    ...
    protected String getFormattedValue(double value, int precision) {
        String formatted = formatter.getFormattedValue(value, precision);
        if (formatted == null)
            return new ValueFormatterImpl().getFormattedValue(value, precision);
        return formatted;
    }

    protected String getFormattedValue(int precision) {
        return getFormattedValue(getValue(), precision);
    }

    public void setPrecision(int  precisionIn)
        {
    ...
    public void setTextSize(float  textSizeIn)
        {
