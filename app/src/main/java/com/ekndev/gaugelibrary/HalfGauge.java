...
public class HalfGauge extends AbstractGauge {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.translate((getWidth() / 2f) - ((getRectRight() / 2f) * getScaleRatio()), getHeight() / 2f - 50f * getScaleRatio());
        canvas.scale(getScaleRatio(), getScaleRatio());
        canvas.drawText(getFormattedValue(getPrecision()) + "", 200f, 240f, getTextPaint());
        canvas.restore();
    ...
    private void drawMinValue(Canvas canvas) {
        ...
        canvas.drawText(getFormattedValue(getMinValue(), getPrecision()) + "", 10f + getPadding(), 130f, getRangeValue(getMinValueTextColor()));
        canvas.restore();
    }
    ...
    private void drawMaxValue(Canvas canvas) {
        ...
        canvas.drawText(getFormattedValue(getMaxValue(), getPrecision()) + "", 390f - getPadding(), 130f, getRangeValue(getMaxValueTextColor()));
        canvas.restore();
    }
